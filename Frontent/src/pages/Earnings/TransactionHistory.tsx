  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {data?.pending_earnings && (
        <div className="bg-gradient-to-r from-brand-50 to-brand-100 border border-brand-300 rounded-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-brand-900 mb-1">Pending Earnings</h3>
