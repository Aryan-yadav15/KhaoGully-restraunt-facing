      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="bg-white p-1 rounded-lg shadow-sm border border-gray-200 flex">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
              filter === 'approved' ? 'bg-green-100 text-green-700 shadow-sm' : 'text-gray-600 hover:bg-gray-50'
            }`}
          >
                    ...
                    <td className="px-6 py-4">
                      ...
                      {owner.restaurant_uid && (
                        <div className="text-xs text-gray-500 mt-1 flex items-center">
                          <svg className="w-3 h-3 mr-1 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                          UID Assigned
                        </div>
                      )}
                    </td>
